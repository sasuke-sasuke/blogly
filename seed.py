...
p8 = Post(title='I just want my brother...', content='I just want my brother back... I wish i never acted like I hated him so much... I love him!', user_id=4)
p2 = Post(title='Hi, my name Tom!', content='I made Myspace, made a bunch of money and sold out like a genius! That Suckerberg dont know what hes doing! LOL', user_id=1)
p3 = Post(title='Training Day 5899', content='I instant transmissioned back home to check in with ChiChi and she is STILL mad at me for training and taking the boys! What if Freeza comes back?? Man it gets me excited!!! I hope he does come back.... low key...', user_id=2)
p4 = Post(title='Kakarot....', content='Im the strongest Saiyan Kakarot.. Im the prince of all saiyans and that means YOU TOO!', user_id=3)
p5 = Post(title='My eyes..', content='Man my eyes have really been hurting recently.. I went to the doctor and he asked about my eye health history........ I have no idea whos eyes I actaully have anymore, so I walked out...', user_id=4)
p6 = Post(title='Believe it!!', content='Believe it!! You can be the Hokage if you really believe it, believe it!', user_id=5)
p7 = Post(title='Bok Bok', content='Bok bok, chicken chicken, bok bok, chicken head!', user_id=6)
